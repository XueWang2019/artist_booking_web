...
```
> **Note** 
> - If we do not mention the specific version of a package, then the default latest stable package will be installed. 
> - I suggest that installing the dependency in vitualenv and use pip freeze to fix the requirements
